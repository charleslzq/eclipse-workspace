...
public class TextStripperByPDFRectangle extends PDFTextStripper{
	...
	public TextStripperByPDFRectangle() throws IOException {
		super();
	 ...
	 protected void processTextPosition( TextPosition text ){
	        ...
	        while( regionIter.hasNext() )
	        {
	            ...
	            if( rect.isInThisArea( text.getTextPos().getValue(2, 0), text.getTextPos().getValue(2, 1) ) )
	            {
	                ...
	                characters.add(new PDFCharacter(region, text));
