...
public class TableExtractorTest {
	...
	public void test() throws Exception {
		...
		System.out.println(tables.get(0).getRowHeaders().size());
		System.out.println(tables.get(0).getRows(tables.get(0).getRowHeaders().get(1).getPta()).get(1).getString());
		txw.writeTable(tables.get(0));
